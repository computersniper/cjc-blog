(() => {
  ...
  const copy = {
    en: { systems: "Systems online", home: "Home", projects: "Projects", journal: "Journal", contact: "Contact", themes: "Themes", openChannel: "Open communication channel", retry: "Retry data link" },
    zh: { systems: "系统在线", home: "首页", projects: "项目", journal: "日志", contact: "联系", themes: "主题", openChannel: "打开通信频道", retry: "重试数据链路" },
  };
