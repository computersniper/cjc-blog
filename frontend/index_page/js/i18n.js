const translations = {
  en: {
    ...
    filter_llm: "LLM & AI Infra",
    filter_sd: "System Design",
  ...
  zh: {
    ...
    im_name: "我是蔡杰超",
    im_title: "一名来自广州的计算机科学学生",
    im_desc1: "我热衷于创造实用、独特且优雅的产品。我保持代码简洁、可读、模块化并持续重构。目前，我专注于 Agent 与大语言模型工程，探索大模型能力边界，并构建 RAG 知识库。",
    im_desc2: "此外，我英语流利，通过了 CET4、CET6，IELTS 6.5，这使我能够与全球程序员有效沟通和协作。",
    edu_bg: "教育背景：",
    edu_hku: "香港大学 (HKU)",
    edu_hku_desc: "计算机科学理学硕士 (2026.9 - 2027.8 预计) | 方向：大模型与 NLP、多智能体系统",
    ...
    core_courses: "核心课程",
    dl_title: "深度学习与神经网络",
    dl_desc: "学习了深度学习和神经网络架构等高级人工智能技术，为大模型工程打下扎实基础。",
    nlp_title: "自然语言处理",
    nlp_desc: "学习了文本处理、语言建模和高级自然语言处理技术，这对理解和开发现代 AI Agent 系统非常重要。",
    ml_title: "机器学习",
    ml_desc: "掌握核心机器学习算法、数据预处理和模型评估指标，并应用于解决复杂的预测和分类问题。",
    dsa_title: "数据结构与算法",
    dsa_desc: "学习从基础到复杂的数据结构与算法，分析时间和空间复杂度，编写优化且高性能的代码。",
    os_title: "操作系统",
    os_desc: "深入理解操作系统原理，包括进程调度、内存管理、文件系统和 Linux 系统编程。",
    net_title: "数据通信与网络",
    net_desc: "学习数据通信原理、OSI 参考模型、TCP/IP 协议，并通过 Socket 编程项目应用这些理论。",

    internship_exp: "实习经历",
    intern_title: "Xnew | AI 平台研发实习生",
    intern_date: "2026.01 - 2026.04",
    intern_desc: "公司简介：一家教育内容服务商，长期为腾讯、阿里、小红书等 AI 厂商提供奥数级别的高质量数学题库数据。",
    intern_bullet1: "全栈开发：负责前后端架构、核心功能开发与测试。",
    intern_bullet2: "数据管线：构建数据清洗和智能标注管线。",
    intern_bullet3: "大模型集成：集成大语言模型，用于评估数学题目质量，包括原创性、难度、严谨性等。",
    intern_bullet4: "网关与指标：部署 LiteLLM 网关，优化调用性能，并实现使用统计与自动化日报。",

    latest_projects: "最新项目",
    tech_stack: "技术栈：",

    msg_box_title: "我的收件箱随时开放。无论你有问题、想打个招呼，还是想联系合作，我都会尽力回复。",

    certificates: "证书",
    cert1_date: "2024年6月27日",
    cert1_tag: "数学建模",
    cert1_title: "成功参加 2024 MCM 竞赛",
    ...
    filter_algo: "算法",
    filter_se: "软件工程",
    filter_llm: "大模型 & AI 基础设施",
    filter_sd: "系统设计",
    filter_rl: "强化学习",
    no_articles: "该分类下暂无文章。",
    no_projects: "暂无项目。",
    ...
    drop_msg: "给我留言",
    inbox_open: "我的收件箱随时开放，我会尽快回复。",
    name_placeholder: "名字",
    email_placeholder: "邮箱",
    msg_placeholder: "你的留言",
    footer_desc: "由蔡杰超设计与开发。",
    admin_panel: "后台管理"
  }
};
